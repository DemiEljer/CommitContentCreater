...
При запуске утилиты, если не было передано ни одного аргумента, будет осуществлен поиск файла конфигрурации в директории вызова утилиты с именени "commit.gen".
